    ...
    return (
        <div>
            <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                <div onClick={() => {handleActivePage(activePage - 1)}} className="relative inline-flex items-center rounded-l-md px-2 py-2 text-sky-900/75 ring-1 ring-inset ring-slate-300 focus:z-20 focus:outline-offset-0 hover:cursor-pointer">
                    ...
                    (pageNumbers.length <= TOTAL_PAGES_SELECTED) ?
                        pageNumbers.map((pageNum) => {
                            return <div key={pageNum} onClick={() => {handleActivePage(pageNum)}} className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold hover:cursor-pointer ${activePage === pageNum ?
                                'z-10 bg-sky-900/75 text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' :
                        ...
                        <div>
                            <div onClick={() => {handleActivePage(firstPage)}} className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold hover:cursor-pointer ${activePage === firstPage ?
                                'z-10 bg-sky-900/75 text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' :
                                'text-sky-900/75 ring-1 ring-inset ring-slate-300 focus:z-20 focus:outline-offset-01'}`}>{firstPage}</div>
                            <div onClick={() => {handleActivePage(secondPage)}} className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold hover:cursor-pointer ${activePage === secondPage ?
                                'z-10 bg-sky-900/75 text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' :
                                'text-sky-900/75 ring-1 ring-inset ring-slate-300 focus:z-20 focus:outline-offset-01'}`}>{secondPage}</div>
                            {!hideDots ? <span className="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-700 ring-1 ring-inset ring-slate-300 focus:outline-offset-0">...</span> : ""}
                            <div onClick={() => {handleActivePage(pageNumbers[pageNumbers.length - 2])}} className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold hover:cursor-pointer ${activePage === pageNumbers[pageNumbers.length - 2] ?
                                'z-10 bg-sky-900/75 text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' :
                                'text-sky-900/75 ring-1 ring-inset ring-slate-300 focus:z-20 focus:outline-offset-01'}`}>{pageNumbers[pageNumbers.length - 2]}</div>
                            <div onClick={() => {handleActivePage(pageNumbers[pageNumbers.length - 1])}} className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold hover:cursor-pointer ${activePage === pageNumbers[pageNumbers.length - 1] ?
                                'z-10 bg-sky-900/75 text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' :
                                'text-sky-900/75 ring-1 ring-inset ring-slate-300 focus:z-20 focus:outline-offset-01'}`}>{pageNumbers[pageNumbers.length - 1]}</div>
                        </div>
                }

                <div onClick={() => {handleActivePage(activePage + 1)}} className="relative inline-flex items-center rounded-r-md px-2 py-2 text-sky-900/75 ring-1 ring-inset ring-slate-300 focus:z-20 focus:outline-offset-0 hover:cursor-pointer">
