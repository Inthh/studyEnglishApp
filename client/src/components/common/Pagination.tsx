    ...
    return (
        <div>
            <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                <div onClick={() => {handleActivePage(activePage - 1)}} className="relative inline-flex items-center rounded-l-md px-2 py-2 text-blue-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 hover:cursor-pointer">
