                    ...
                    <div className="grid grid-rows-[80%_20%] gap-y-2 items-center">
                        ...
                        <div className="grid justify-items-end sm:mr-0 mr-4">
                            <button 
                                ...
                                className="h-[40px] w-[100px] bg-blue-600 dark:bg-blue-500 rounded dark:text-slate-300 text-slate-100 hover:bg-blue-500 dark:hover:bg-blue-400" onClick={handleSubmitParagraph}>
                                Check
                            </button>
                        </div>
                    </div>
